...
export function generateLocalPageMetadata(zone: string, zoneDisplay: string): Metadata {
  return {
    ...
    description: `Préparez votre dossier en 30 min. Au moins 3 devis personnalisés sous 7 jours pour ${zoneDisplay} (nantes).`,
    alternates: {
      canonical: `https://www.nantes-demenageur.fr/${zone}`,
    },
    openGraph: {
      title: `Déménageur ${zoneDisplay} — Comparez des devis fiables | Moverz`,
      description: `Préparez votre dossier en 30 min. Au moins 3 devis personnalisés sous 7 jours pour ${zoneDisplay} (nantes).`,
      url: `https://www.nantes-demenageur.fr/${zone}`,
      type: 'website',
    },
  };
}
      ...
      <div className="min-h-screen bg-[#04163a]">
                ...
                <div className="relative w-full max-w-5xl mx-auto h-64 md:h-80 rounded-2xl overflow-hidden mb-8">
                  ...
                  <div className="absolute bottom-6 left-6 flex items-center gap-3">
                    ...
                    <div className="text-left">
                      ...
                      <div className="text-white/80 text-sm">nantes</div>
                    </div>
                  </div>
                </div>
              )}
        ...
        <div className="container max-w-4xl mx-auto px-4 md:px-6 py-12">
          ...
          <div className="flex flex-wrap justify-center gap-3">
            {['nantes intra-muros', 'Gironde', 'Pays de la Loire', 'France entière', 'Europe'].map((dest) => (
