...
const nextConfig = {
  ...
  async redirects() {
    const existing = [
      ...
      { source: '/services/demenagement-economique-nantes/', destination: 'https://moverz.fr/services/demenagement-economique/', permanent: true },
      { source: '/services/demenagement-premium-nantes/', destination: 'https://moverz.fr/services/demenagement-premium/', permanent: true },
      { source: '/services/demenagement-standard-nantes/', destination: 'https://moverz.fr/services/demenagement-standard/', permanent: true },
      // Pages communes
